...
export function setConfig(output: string,  spike: SpikeConfig, sinkState?: boolean, github?: { mode: GithubExportMode }, repo?: string, googleType?: "gmail" | "calendar", start?: Date, end?: Date, categories?: string[]): Config {
    return{
